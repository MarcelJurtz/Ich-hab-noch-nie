...
public class MessageHelper {
    ...
    public static HashSet<Message> getMessages() {
        ...
        messages.add(new Message("die Schule abgebrochen",date4, user));
        messages.add(new Message("die Schule geschwänzt",date4, user));
        ...
        messages.add(new Message("ein Kondom mehrmals verwendet",date4, user));
        messages.add(new Message("ein Krokodil / einen Alligator in freier Wildbahn gesehen",date4, user));
        ...
        messages.add(new Message("einen Fallschirmsprung gemacht",date4, user));
        ...
        messages.add(new Message("einen Polizisten angelogen",date4, user));
        ...
        messages.add(new Message("Gleitgel verwendet",date4,user));
        messages.add(new Message("Gras geraucht",date4, user));
        messages.add(new Message("gesagt bekommen, ich sei zu schnell gekommen",date2,user));
        messages.add(new Message("gewählt",date4, user));
        ...
        messages.add(new Message("heimlich das Zimmer eines Freundes / einer Freundin durchsucht",date4, user));
        messages.add(new Message("Helium inhaliert",date4, user));
        messages.add(new Message("hinter dem Kühlschrank sauber gemacht",date2,user));
        messages.add(new Message("Hummer gegessen",date4, user));
        ...
        messages.add(new Message("im Aufzug gekotzt",date4, user));
        messages.add(new Message("im Aufzug getanzt",date4, user));
        ...
        messages.add(new Message("in ein Waschbecken gepinkelt",date4, user));
        ...
        messages.add(new Message("jemanden zu einem Piercing überredet",date4, user));
        messages.add(new Message("jemanden zu einem Tattoo überredet",date4, user));
        ...
        messages.add(new Message("meine Brüste geleckt",date4,user));
        ...
        messages.add(new Message("mit dem Kopf auf der Kloschüssel geschlafen",date4,user));
        ...
        messages.add(new Message("Sex mit 2 verschiedenen Menschen gehabt, ohne dazwischen zu duschen",date4, user));
        ...
        messages.add(new Message("sexuelle Fantasien mit einem Familienmitglied",date4, user));
        ...
        messages.add(new Message("Sozialstunden machen müssen",date4, user));
        messages.add(new Message("Sperma geschmeckt",date,user));
        messages.add(new Message("Sperma im Gesicht gehabt",date4,user));
        ...
        messages.add(new Message("Tintenfisch gegessen",date4, user));
        messages.add(new Message("\"Titanic\" gesehen",date4, user));
        ...
        messages.add(new Message("vegetarisch gelebt",date4, user));
